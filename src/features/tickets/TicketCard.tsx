  ...
  return (
    <Link to={`/aufgaben/${ticket.id}`} className="block group">
      ...
      >
        ...
        {/* Title */}
        <h3 className="font-medium text-sage-800 dark:text-sage-100 line-clamp-2 mb-2 transition-colors duration-150 group-hover:text-warmth-600 dark:group-hover:text-warmth-400">
          {ticket.title}
        </h3>
        ...
        <div className="flex items-center justify-between">
          ...
          {assignee ? (
            ...
            <div className="h-9 w-9 rounded-full bg-sage-100 dark:bg-sage-700 flex items-center justify-center">
