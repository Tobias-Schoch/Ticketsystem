...
export function CreateTicketPage() {
  return (
    <div className="max-w-2xl mx-auto animate-fade-in">
      {/* Header */}
      <div className="relative overflow-hidden bg-gradient-to-br from-warmth-50 via-sand-50 to-sand-100 dark:from-warmth-900/30 dark:via-sage-900/50 dark:to-sage-900/30 rounded-2xl sm:rounded-3xl p-5 sm:p-8 mb-4 sm:mb-6 border border-sand-200 dark:border-sage-700">
