...
export function DashboardPage() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 lg:space-y-8 animate-fade-in">
      {/* Welcome Section */}
      <div className="relative overflow-hidden bg-gradient-to-br from-warmth-50 via-sand-50 to-sand-100 dark:from-warmth-900/30 dark:via-sage-900/50 dark:to-sage-900/30 rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-sand-200 dark:border-sage-700">
        ...
        <div className="absolute bottom-0 right-12 sm:right-20 w-16 sm:w-24 h-16 sm:h-24 bg-sand-300/30 dark:bg-sage-700/20 rounded-full blur-2xl hidden sm:block" />
      </div>
